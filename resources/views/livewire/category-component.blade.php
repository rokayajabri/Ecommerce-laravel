                    ...
                    <div class="col-lg-9">
                        <div class="shop-product-fillter">
                            <div class="totall-product">
                                <p> We found <strong class="text-brand">{{$produits->total()}}</strong> items for you form <strong class="text-brand">{{$category_name}}</strong> category!</p>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-6 col-sm-6">
                                <div class="product-cart-wrap mb-30">
                                    ...
                                    <div class="product-content-wrap">
                                        <h2><a href="{{route('product.details',['slug'=>$produit->slug])}}">{{$produit->nom_produit}}</a></h2>
                                        ...
                                        <div class="product-action-1 show">
                                            <a aria-label="Add To Cart" class="action-btn hover-up" href="{{route('shop.cart')}}" wire:click.prevent="store({{$produit->id}},`{{$produit->nom_produit}}`,{{$produit->prix}})"><i class="fi-rs-shopping-bag-add"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-3 primary-sidebar sticky-sidebar">
                        ...
                        <div class="widget-category mb-30">
                            ...
                            <ul class="categories">
                                @foreach ($categories as $categorie )
                                    <li><a href="{{route('product.category',['slug'=>$categorie->slug])}}">{{$categorie->libelle}}</a></li>
                                @endforeach
                            </ul>
                        </div>
                        <!-- Fillter By Price -->
                        <div class="sidebar-widget price_range range mb-30">
                            <div class="widget-header position-relative mb-20 pb-10">
                                <h5 class="widget-title mb-10">Filter by price Or Name</h5>
                        ...
                        <div class="sidebar-widget product-sidebar  mb-30 p-30 bg-grey border-radius-10">
                            ...
                            <div class="single-post clearfix">
                                <div class="image">
                                    <img src="{{asset('assets/imgs/produits')}}/{{$nproduit->image}}" alt="{{$nproduit->nom_produit}}">
                                </div>
                                <div class="content pt-10">
                                    <h5><a href="{{route('product.details',['slug'=>$nproduit->slug])}}">{{$nproduit->nom_produit}}</a></h5>
