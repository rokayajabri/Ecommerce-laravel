                ...
                <div class="row">
                    <div class="col-12">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="product-des product-name">
                                            <h5 class="product-name"><a href="#">{{$item->model->nom_produit}}</a></h5>
                                           {{--<p class="font-xs">Maboriosam in a tonto nesciung eget<br> distingy magndapibus.
                                            </p>--}}
                                        </td>
                                        <td class="price" data-title="Price"><span>${{$item->model->prix}} </span></td>
                        ...
                        <div class="cart-action text-end">
                            <a class="btn  mr-10 mb-sm-15" href="{{ route('pdf') }}"><i class="fi-rs-shuffle mr-10"></i> PDF Bills</a>
                        ...
                        <div class="row mb-50">
                            <div class="col-lg-6 col-md-12">
                                <div class="border p-md-4 p-30 border-radius cart-totals">
                                    ...
                                    @else
                                        <a href="{{url('login')}}" class="btn "> <i class="fi-rs-box-alt mr-10"></i> Proceed To CheckOut</a>
                                    @endif
                                </div>
                            </div>
                        </div>
