...
<head>
    <meta charset="utf-8">
<title>E-commerce en ligne</title>
            ...
            <div class="container">
                <div class="header-wrap">
                    <div class="logo logo-width-1">
                        <a href="{{route('home.index')}}"><h1>E-commerce en ligne</h1></a>
                    </div>
                                    ...
                                    <li><a href="#">My Account<i class="fi-rs-angle-down"></i></a>
                                            @if(Auth::user()->utype=='ADM')
                                                <ul class="sub-menu">
                                                    ...
                                                    <li><a href="{{route('admin.users')}}">Clients</a></li>
                                                </ul>
                                            @else
                                                <ul class="sub-menu">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="widget-about font-md mb-md-5 mb-lg-0">
                            <div class="logo logo-width-1 wow fadeIn animated">
                                <a href="{{route('home.index')}}"><h4>E-commerce en ligne</h4></a>
                            </div>
                            <h5 class="mt-20 mb-10 fw-600 text-grey-4 wow fadeIn animated">Contact</h5>
                            <p class="wow fadeIn animated">
                                <strong>Address: </strong>562 Tetouan
                            </p>
                            <p class="wow fadeIn animated">
                                <strong>Phone: </strong>+212 60 00 00 00 00
                            </p>
                            <p class="wow fadeIn animated">
